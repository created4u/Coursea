...
struct AccountView: View {
    ...
    func getInfo() {
        ...
        Task {
            student = await dataManager.getStudent(account: account)
            ...
            VStack {
                ...
                Form {
                    ...
                    Section {
                        ...
                        NavigationLink(destination: Information(name: $name, account: $account, gender: $gender, major: $major, birthDate: $birthDate, phoneNumber: $phoneNumber)) {
...
struct Information: View {
    ...
    func confirmChangeInfo() {
        ...
        dataManager.updateBasicInfo(account: account, birthDate: birthDate, phoneNumber: phoneNumber)
    }
}
        ...
        Form {
            ...
            Section {
                ...
                .alert(isPresented: $resetPassword) {
                    reset(email: emailAddress ?? "songzlWork@outlook.com")
                }
            }
        }
    }
